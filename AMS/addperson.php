...
<body>
    <header>
        <nav>
            ...
            <ul id="navli">
                ...
                <li><a class="homered" href="addperson.php">Add Person</a></li>
    ...
    color: white;
    border-radius: 5%;">
                    <h2 class="title">Person Information</h2>
                    <form action="process/addpersonprocess.php" method="POST" enctype="multipart/form-data">
